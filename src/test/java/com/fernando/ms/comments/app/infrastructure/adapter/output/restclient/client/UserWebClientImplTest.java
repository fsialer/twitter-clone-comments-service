...
import com.fernando.ms.comments.app.infraestructure.adapter.output.restclient.client.impl.UserWebClientImpl;
...
class UserWebClientImplTest {
    ...
    void When_ServiceUserFindMe_Expect_AnUser(){
        ...
        Mockito.<WebClient.RequestHeadersSpec<?>>when(requestHeadersUriSpec.uri("/{userId}/user-id",userId)).thenReturn(requestHeadersSpec);
